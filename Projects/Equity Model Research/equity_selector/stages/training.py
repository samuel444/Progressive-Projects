...
def run():
    ...
    HIST_GRADIENT_PARAMS = get_setting("HIST_GRADIENT_PARAMS", {
    ...
    GRADIENT_BOOSTING_PARAMS = get_setting("GRADIENT_BOOSTING_PARAMS",{
        "learning_rate": LEARNING_RATES,
        "n_estimators": [200],
        "max_depth": [3],
        "min_samples_leaf": [20],
    ...
    ALL_CONTINUOUS_MODELS = choose_catalogue(
        "ALL_CONTINUOUS_MODELS",
        ALL_CONTINUOUS_MODELS,
        get_setting("LEGACY_CONTINUOUS_MODELS", None)
    )
    ALL_BINARY_MODELS = choose_catalogue(
        "ALL_BINARY_MODELS",
        ALL_BINARY_MODELS,
        get_setting("LEGACY_BINARY_MODELS", None),
    )
    ALL_MULTICLASS_MODELS = choose_catalogue(
        "ALL_MULTICLASS_MODELS",
        ALL_MULTICLASS_MODELS,
        get_setting("LEGACY_MULTICLASS_MODELS", None),
    )
    logger.info(
