...
from horizon_score.portfolio import capped_weights, portfolio_returns_from_scores
...
def test_precise_uses_shared_portfolio_and_metrics():
    spec = importlib.util.spec_from_file_location(
        "precise_fixture", Path(__file__).parents[1] / "horizon_score/stages/precise.py"
    )
